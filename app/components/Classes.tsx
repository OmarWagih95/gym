  ...
  return (
    <section id='classes' className='pt-7 h-auto lg:h-auto  bg-white'>
      <div className='grid grid-cols-1 lg:grid-cols-2' >
        ...
        key={index} className='relative flex flex-col justify-center h-[200px] lg:h-[280px] items-center text-center '>
            ...
            <div className='flex flex-col items-center h-[140px] justify-between text-center' >
                ...
                className='text-gray-300 text-sm max-w-[300px] z-10'>{item.desc}</p>
